...
<![endif]-->
<!--docodocojp-->
<script type="text/javascript" src="//api.docodoco.jp/v4/docodoco?key=D1lpT0XE8uncR79PKvmPusqRTf6pRPnUtVccxEZp9OlzAjM4eQRzzTe5Sk6q5eRN"
charset="utf-8"></script>
<script type="text/javascript" src="/common/js/docodoco_ua_plugin_2.js"
charset="utf-8"></script>
<!--Google Analytics-->
<script>
...
<header id="header">
        ...
        <div class="inner">
            ...
            <div id="btns" class="clearfix">
                <ul id="fontSize" class="clearfix">
                    <li>文字サイズ</li>
                    <li><img class="changeBtn" src="/common/img/hb01.png" alt="標準"></li>
                    <li><img class="changeBtn" src="/common/img/hb02.png" alt="拡大"></li>
                </ul>
                <ul id="headerBtns" class="thinImg clearfix">
                    <li><a href="/sitemap/"><img src="/common/img/hb03.png" alt="サイトマップ"></a></li>
                    <li><a href="#login"><img src="/common/img/hb04.png" alt="ログイン"></a></li>
                    <li><a href="/en/"><img src="/common/img/hb05.png" alt="English"></a></li>
                </ul>
            </div>
            <div id="search">
    ...
    <div class="inner">
        <ul class="clearfix">
            ...
            <li class="gm02"><a href="/ratinglist/">格付一覧</a></li>
            <li class="gm03"><a href="/rrinfo/">格付関連情報</a></li>
            <li class="gm04"><a href="/service/">関連業務等</a></li>
            <li class="gm05"><a href="/service/international/">グローバルな取り組み</a></li>
            <li class="gm06"><a href="/service/company/">会社案内</a></li>
...
<article id="content">
    <div class="inner changeArea clearfix">
        <div class="mainColumn">
                    ...
                    <ul class="clearfix">
                        <li><a href="/">ホーム</a></li>
                        <li>グリーン・ファイナンスへの取り組み</li>
                    </ul>
                </div>
                <div><img src="/common/img/g_main.png" alt="GO GREEN!"></div>
        ...
        <div class="subColumn thinImg">
            <div class="sideBnrs">
    <ul>
        <li><a href="/acquisition/"><img src="/common/img/bnr02.png?1" alt=""></a></li>
        <li><a href="/greenfinance/"><img src="/common/img/bnr01.png?1" alt=""></a></li>
        <li><a href="/service/provision/"><img src="/common/img/bnr03.png?1" alt=""></a></li>
    </ul>
</div>                          <div class="sideNav">
                    <dl>
                        <dt>GO GREEN!</dt>
                        <dd><a href="#greenfinance">グリーン・ファイナンスへの取り組み</a></dd>
                        <dd><a href="#esg">ESG</a></dd>
                    </dl>
                </div>                  </div>
    </div>
</article>
<footer id="footer">
    <div class="inner">
        <ul class="clearfix">
            <li><a href="/criterion/">JCR行動規範</a></li>
            <li><a href="/pdf/dm65/privacypolicy20161003.pdf" target="_blank">個人情報保護方針</a></li>
            <li><a href="/pdf/dm66/conflicts-of-interest-management-policy20171220.pdf" target="_blank">利益相反管理方針</a></li>
            <li><a href="/pdf/dm67/antisocial.pdf" target="_blank">反社会的勢力に対する基本方針</a></li>
            <li><a href="/immunity/">免責事項</a></li>
        </ul>
        <div id="pagetop" class="thinImg"><a href="#header"><img src="/common/img/pagetop01.gif" alt="PAGE TOP"></a></div>
        <p id="copyright"><small>Copyright &#169; 2016 日本格付研究所 All Rights Reserved.</small></p>
    </div>
</footer>
<div id="modal">
    <div id="login">
    <a href="#" class="close_overlay">×</a>
        <div class="modal_window">
            ...
            <form action="https://www.jcr.co.jp/login/login" name="form" accept-charset="utf-8" method="post"><input name="token" value="cd95763af58a8602fdea61da9779e935a73208234000292f5a970bebfc77d8b9e6d8a7b90230b51b849402f0ab420b79d71428baf38e30c72a25c1c79917ddfe" type="hidden" id="form_token" />             <div class="loginform">
                    <dl>
                        <dt>ID</dt>
                        <dd>
                    ...
                    <dl>
                        <dt>&nbsp;</dt>
                        <dd><label><label><input name="save" value="1" type="checkbox" id="form_save" /></label> 次回からのID入力を省略</label></dd>
                    </dl>
                </div>
                <div class="login_btn"><input type="submit" value="ログイン"></div>
            </form>         <div class="login_footer">
                <p class="title">有料会員登録をするには</p>
                <p>情報提供サービスRatingEyeへの有料会員登録が必要となります。<br>
                RatingEyeに関する詳しい情報やお申し込みは下記PDFをご確認ください。</p>
                <p class="pdf"><a href="/pdf/RatingEye_Info_180523_JP.pdf" target="_blank">情報提供サービスRatingEyeについて</a></p>
            </div>
        </div><!--/.modal_window-->
    </div><!--/#login-->
</div><!--/#modal-->
<script src="/common/js/modal.js"></script></body>
</html>